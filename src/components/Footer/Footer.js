      ...
      <Container maxWidth="lg">
        <Grid container>
          ...
          <Grid item xs={6} style={{ textAlign: 'right' }}>
            <a
              href="https://twitter.com/bathfinance"
            ...
            <a
              href="https://github.com/bathfinance/bathfinance-frontend"
              rel="noopener noreferrer"
              target="_blank"
              className={classes.link}
            >
            ...
            <a href="https://t.me/bathfinance" rel="noopener noreferrer" target="_blank" className={classes.link}>
