...
const configurations: { [env: string]: Configuration } = {
  development: {
    ...
    defaultProvider: 'https://endpoints.omniatech.io/v1/bsc/testnet/public',
    deployments: require('./tomb-finance/deployments/deployments.testing.json'),
    externalTokens: {
      /////////////////////////////////////////
      GENESIS: ['0x424A939b14BB4947482AC9CDCB9d436F922E073b', 0],
      STEAMROOM: ['0xfAb1CBc1C190888E6a6e98b374f681bB0c02Ae12', 0],
      JACUZZI: ['0x986240C1065A8216508b3a04Edec4448768784eE', 0],
      SAUNA: ['0x83F102565b5Be67c5376Ae11Ffe78c551B605130', 0],
      ////////////////////////////////////////
