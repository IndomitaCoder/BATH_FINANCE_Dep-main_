...
import { POOL_TOKEN_PAIR_3 } from '../../utils/constants';
...
const Farm3 = () => {
  ...
  const pooinfo = POOL_TOKEN_PAIR_3;
  ...
  const fetchData = async () => {
    let start = await tombFinance?.SAUNA?.poolStartTime();
    let end = await tombFinance?.SAUNA?.poolEndTime()
