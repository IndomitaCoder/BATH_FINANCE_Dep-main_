...
export const POOL_TOKEN_PAIR = [['BATH', 'BNB'], ['TUB', 'BNB']];
export const POOL_TOKEN_PAIR_1 = [['BATH', 'BNB'], ['TUB', 'BNB']];
export const POOL_TOKEN_PAIR_2 = [['BATH', 'BNB'], ['TUB', 'BNB']];
export const POOL_TOKEN_PAIR_3 = [['BATH', 'BNB'], ['TUB', 'BNB']];
